...
# Kernel base version
KERNEL_BASE_VERSION = 4.19.313

# The kernel cmdline to use
KERNEL_BOOTIMAGE_CMDLINE = console=tty0 earlycon=msm_geni_serial,0x4a90000 androidboot.hardware=qcom androidboot.console=tty0 androidboot.memcg=1 lpm_levels.sleep_disabled=1 video=vfb:640x400,bpp=32,memsize=3072000 msm_rtb.filter=0x237 service_locator.enable=1 swiotlb=2048 loop.max_part=7 buildvariant=user datapart=/dev/sda16
...
DEVICE_FULL_NAME = Redmi Note 11
...
# Defconfig to use
KERNEL_DEFCONFIG = halium_defconfig
...
# Android property. If you don't want to specify this, leave it undefined,
# FLASH_INFO_CPU will be checked instead.
FLASH_INFO_MODEL = Redmi Note 11
...
FLASH_INFO_DEVICE_IDS = spes spesn
...
DEB_TOOLCHAIN = linux-initramfs-halium-generic:arm64, binutils-aarch64-linux-gnu, gcc-4.9-aarch64-linux-android, g++-4.9-aarch64-linux-android 
